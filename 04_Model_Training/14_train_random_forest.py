...
for i in range(1, 6):
    ...
    joblib.dump(clf, f"models/random_forest/fold{i}_model.pkl")
...
imp_df.to_csv("results/rf_feature_importance.csv")

print("\nMean results:")
print(results_df[["accuracy","f1","auc","fpr"]].mean().round(4))
print("\nTop 10 features:")
print(imp_df["mean_importance"].head(10))
print("\nSaved to results/rf_results.csv and results/rf_feature_importance.csv")