...
print("Loading ChatGPT detector (Hello-SimpleAI/chatgpt-detector-roberta)...")
detector = pipeline("text-classification", model="Hello-SimpleAI/chatgpt-detector-roberta", truncation=True, max_length=512)
print("Model loaded.\n")
...
results_df.to_csv("results/chatgpt_detector_results.csv", index=False)
print("\nMean results:")
print(results_df[["accuracy","f1","auc","fpr"]].mean().round(4))
print("\nSaved to results/chatgpt_detector_results.csv")